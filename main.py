...
inputData = "пара-ра-рам рам-пам-папам па-ра-па-да".split()
vowels = "ауоыиэяюёе"

filtered = set(
    map(lambda item: len(list(filter(lambda let: let in vowels, item))), inputData)
)
print("“Пам парам”" if len(filtered) > 1 else "“Парам пам-пам”")
